...
public class PassportServerConstants {
    ...
    public static final String USER_PASSPORT_CONFIG_CONTAINER = "userPassportConfigContainer";
    public static final String FINAL_PASSPORT_CONFIG_CONTAINER = "finalPassportConfigContainer";
